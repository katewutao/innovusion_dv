...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_5.setGeometry(QtCore.QRect(10, 210, 80, 20))
        ...
        self.label_7.setGeometry(QtCore.QRect(210, 60, 171, 21))
        ...
        self.txt_off_counter.setGeometry(QtCore.QRect(380, 60, 41, 25))
        self.txt_off_counter.setObjectName("txt_off_counter")
        self.label_8 = QtWidgets.QLabel(self.frame)
        self.label_8.setGeometry(QtCore.QRect(430, 60, 121, 21))
        self.label_8.setObjectName("label_8")
        self.txt_record_interval = QtWidgets.QLineEdit(self.frame)
        self.txt_record_interval.setGeometry(QtCore.QRect(570, 60, 31, 25))
        self.txt_record_interval.setObjectName("txt_record_interval")
        self.label_9 = QtWidgets.QLabel(self.frame)
        self.label_9.setGeometry(QtCore.QRect(630, 60, 81, 21))
        self.label_9.setObjectName("label_9")
        self.txt_timeout = QtWidgets.QLineEdit(self.frame)
        self.txt_timeout.setGeometry(QtCore.QRect(730, 60, 31, 25))
        ...
        self.relay.setGeometry(QtCore.QRect(830, 70, 61, 21))
        self.relay.setObjectName("relay")
        self.dsp = QtWidgets.QCheckBox(self.frame)
        self.dsp.setGeometry(QtCore.QRect(780, 70, 51, 21))
        self.dsp.setObjectName("dsp")
        self.cb_pointcloud = QtWidgets.QCheckBox(self.frame)
        self.cb_pointcloud.setGeometry(QtCore.QRect(780, 50, 101, 21))
        ...
        self.scrollArea.setGeometry(QtCore.QRect(920, 80, 501, 791))
        self.scrollArea.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.scrollArea.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 482, 772))
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(10, 230, 901, 171))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionlidar_status.setText(_translate("MainWindow", "lidar status"))
        self.actionlidar_pointcloud.setText(_translate("MainWindow", "lidar pointcloud"))
